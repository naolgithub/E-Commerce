...
import 'package:ecommerce/pages/SignInPage/sign_in_page.dart';
import 'package:ecommerce/providers/loginscreen_provider.dart';
import 'package:ecommerce/services/firebase_auth.dart';
                ...
                return FadeInLeft(
                  child: GestureDetector(
                    onTap: (() async {
                      ...
                      await _authentication.loginWithEmail(value.emailText.text,
                          value.passwordText.text, context);
